...
function MedicalCenter() {
  ...
  useEffect(() => {
    if (schdule_update_list) {
      if (
        schdule_update_list?.data?.statusCode == "200" ||
        schdule_update_list?.data?.statusCode == "201" ||
        schdule_update_list
      ) {
        // setMedicalData([]);
        setWeekWithDate();
                          ...
                          <div className="speciality-dctr">
                            ...
                            <p>
                              ...
                              {editprofiles?.includes(val?.doctor?._id) ? (
                                ...
                                <span>
                                  {" "}
                                  {val?.scheduleList?.[0]?.price} Dinar Dinar
                                </span>
                              )}
                            </p>
                          </div>
